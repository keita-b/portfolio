  ...
  return (
    <div className="mx-auto px-6 py-6 space-y-6">        
        <p className="text-gray-500 leading-relaxed">
            ...
            <br />
            そこで、予約プロセスの自動化を提案し、Pythonの数理最適化ライブラリ「PuLP」を用いて、印刷スケジュールを自動生成するシステムを構築。生徒の空き時間を記載したExcelファイルをアップロードするだけで、最適な印刷スケジュールを出力できる仕組みです。
        </p>
        ...
        <div className='mt-12'>
            <p className="text-gray-500 leading-relaxed mb-2">
                ② 印刷スケジュールの自動生成・表示
                <br />
                アップロードされた情報を元に、印刷機を使用する時間帯の数を最小化するよう最適化されたスケジュールを出力。出力結果は日付ごとの表として表示・ダウンロード可能です。
            </p>
            <div className="relative mx-auto w-full">
                <Image
