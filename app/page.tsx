...
大学
法政大学デザイン工学研究科システムデザイン専攻２年

趣味
私は、音楽が大好きです。
Spotifyでは、1920〜2020代までの10年ごとのプレイリストを作るほど好きです。
音楽の背景を調べるのも好きで、いろんなものに興味が派生している。
映画、漫画、本…など。音楽を基点に知的好奇心が循環するのが楽しい。
Threadsで好きな音楽を紹介しているので、よければ覗いてみてください。
https://www.threads.com/@atiekiami
